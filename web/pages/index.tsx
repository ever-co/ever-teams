...
const Home: NextPage = () => {
  return (
    <>
      <section className="bg-white dark:bg-dark_background_color">
        <div className="flex grid-cols-4 py-36 px-6 justify-between">
          <div className="col-span-2">
            <div className="max-w-sm rounded drop-shadow-md bg-white dark:bg-dark_card_background_color dark:bg-opacity-30">
            ...
            <div className="text-base font-light text-gray-900 mt-3 dark:text-white">
              Estimated: 40h:15min
            </div>
          </div>
          <div className="col-span-2 justify-end flex">
            <div className="w-96 rounded drop-shadow-md bg-white px-4 py-4 dark:bg-dark_card_background_color dark:bg-opacity-30">
              ...
              <div className="flex flex-row py-2">
                <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-300">
                  <div
                    className="bg-primary h-2.5 rounded-full dark:bg-button_dark"
                    style={{ width: "45%" }}
                  ></div>
                </div>
              </div>
