...
const Header = ({ style }: IHeader) => {
  return (
    <li className="flex justify-between px-5 py-2 mb-3 items-center rounded-md">
      <div
        style={style}
        className="text-sm pr-2 text-left text-primary font-bold bg-transparent whitespace-nowrap shadow-transparent"
      >
      ...
      <div style={style}>
        <div className="text-sm text-primary font-bold">Estimate</div>
      </div>
      <div
        style={style}
        className="text-center text-sm text-primary font-bold align-middle bg-transparent whitespace-nowrap shadow-transparent"
      >
        Total
      </div>
    </li>
