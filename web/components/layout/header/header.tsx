...
export const Header = () => (
    <header  className="fixed w-full">
        <nav className="bg-white px-4 lg:px-10 py-6  shadow-md">
                        ...
                        <li className="flex items-center px-4">
                            <a href="#" className="p-0 transition-all text-sm ease-nav-brand text-slate-500">
                                <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15 2.83331H4.99999C3.15904 2.83331 1.66666 4.3257 1.66666 6.16665V14.5C1.66666 16.3409 3.15904 17.8333 4.99999 17.8333H15C16.8409 17.8333 18.3333 16.3409 18.3333 14.5V6.16665C18.3333 4.3257 16.8409 2.83331 15 2.83331Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M6.66666 1.16666V4.49999M13.3333 1.16666V4.49999M1.66666 7.83332H18.3333" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </a>
                        </li>
