            ...
            <div className="flex w-full flex-wrap">
              ...
              <div className="md:flex md:items-center mb-3 w-full">
                ...
                <div className="md:w-2/3">
                  <input
                    className="bg-gray-200 appearance-none border-2 border-gray-200 rounded-sm w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                    id="PORT"
                    type="text"
                    placeholder="Port"
