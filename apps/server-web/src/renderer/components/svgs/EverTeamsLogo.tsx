export const EverTeamsLogo = () => {
  return (
    <svg
      ...
      id="ever-teams-logo"
      className="mb-1 cursor-pointer fill-black brightness-0 invert-0 dark:fill-white dark:invert"
    >
      <defs>
        <style type="text/css">
          @import
          url('https://fonts.googleapis.com/css2?family=Fira+Sans:ital,wght@1,300');
        </style>
      </defs>
      <g
