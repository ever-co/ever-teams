...
export const DemoText: Demo = {
	...
	data: [
		<DemoUseCase name="Presets" description="There are a few presets that are preconfigured.">
			<Text>
				default preset - Cillum eu laboris in labore. Excepteur mollit tempor reprehenderit fugiat elit et eu
				consequat laborum.
			</Text>
			...
			<Text preset="bold">
				bold preset - Tempor et ullamco cupidatat in officia. Nulla ea duis elit id sunt ipsum cillum duis
		...
		<DemoUseCase name="Styling" description="The component can be styled easily.">
			<Text>
				...
				<Text style={{ color: colors.palette.neutral100, backgroundColor: colors.error }}>
					Eiusmod occaecat laboris eu ex veniam ipsum adipisicing consectetur. Magna ullamco adipisicing
					tempor adipisicing.
				</Text>
				{` `}
				<Text
