            ...
            <Card style={[styles.timerCard, { backgroundColor: colors.background }]}>
                ...
                {showTaskDropdown ? (
                    <>
                        ...
                        <View style={{ width: "75%", flexDirection: "row", justifyContent: "space-between", marginTop: 16 }}>
                            <Skeleton height={26} width={110} borderRadius={38} />
                            <Skeleton height={26} width={110} borderRadius={38} />
                        </View>

                        <View style={{ marginTop: 16, flexDirection: "row", justifyContent: "space-between", paddingVertical: 16, borderTopColor: colors.border, borderTopWidth: 1, alignItems: "center" }}>
                            <Skeleton height={9} width={101} borderRadius={50} />
                            <Skeleton height={33} width={113} borderRadius={10} />

                            <View style={{ flexDirection: "row", alignItems:"center" }}>
                                <View style={{ flexDirection: "row", alignItems:"center", marginRight:5}}>
                                    <Skeleton height={28} width={28} borderRadius={14} style={{ position: "absolute", right: 12, borderColor: colors.background, borderWidth: 2, zIndex: 1000 }} />
                                    <Skeleton height={28} width={28} borderRadius={14} style={{ borderColor: colors.background, borderWidth: 2 }} />
                                </View>
                                <Skeleton height={9} width={11} borderRadius={50} />
                            </View>
                        </View>

                        <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 16, borderTopColor: colors.border, borderTopWidth: 1, alignItems: "center" }}>
                            <Skeleton height={9} width={101} borderRadius={50} />
                            <Skeleton height={33} width={113} borderRadius={10} />
                    ...
                    <>
                        ...
                        <View style={{ width: "100%", marginTop: 24, paddingBottom: 24, borderBottomColor:colors.border, borderBottomWidth: 1 }}>
                            <Skeleton height={32} borderRadius={10} />
                        </View>

                        <View style={{ width: "100%", marginTop: 33, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                            <View style={{ width: "60%" }}>
