...
const UpdateContactForm = ({
	...
	if (emailChanged) {
		return (
			...
			>
				<ConfirmEmailPopup newEmail={userEmail} visible={showConfirmPopup} onDismiss={() => onDismissPopup()} />
				<View style={{ flex: 3 }}>
					<Text style={{ ...styles.formTitle, color: colors.primary }}>{'Change to new email?'}</Text>
					<TextInput
						style={{
							...styles.styleInput,
