...
const TaskLabelForm = ({
	...
	return (
		...
		>
			...
			/>
			<ColorPickerModal visible={colorModalVisible} onDismiss={onDismissModal} setColor={setLabelColor} />
			...
			<TouchableOpacity style={styles.colorModalButton} onPress={() => setIconModalVisible(true)}>
				<View style={{ flexDirection: 'row', alignItems: 'center' }}>
					<SvgUri width={20} height={20} uri={allIcons?.find((icon) => icon.path === labelIcon)?.fullUrl} />
					<Text
						style={{
							marginLeft: 10,
			...
			<TouchableOpacity style={styles.colorModalButton} onPress={() => setColorModalVisible(true)}>
				<View style={{ flexDirection: 'row', alignItems: 'center' }}>
					...
					>
						{labelColor?.toUpperCase() || translate('settingScreen.statusScreen.statusColorPlaceholder')}
					</Text>
				</View>
			</TouchableOpacity>
