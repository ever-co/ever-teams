...
const TaskSizeForm = ({
	...
	return (
		...
		>
			...
			/>
			<ColorPickerModal visible={colorModalVisible} onDismiss={onDismissModal} setColor={setSizeColor} />
			...
			<TouchableOpacity style={styles.colorModalButton} onPress={() => setIconModalVisible(true)}>
				<View style={{ flexDirection: 'row', alignItems: 'center' }}>
					<SvgUri width={20} height={20} uri={allIcons?.find((icon) => icon.path === sizeIcon)?.fullUrl} />
					<Text
						style={{
							marginLeft: 10,
			...
			<TouchableOpacity style={styles.colorModalButton} onPress={() => setColorModalVisible(true)}>
				<View style={{ flexDirection: 'row', alignItems: 'center' }}>
					...
					>
						{sizeColor?.toUpperCase() || translate('settingScreen.statusScreen.statusColorPlaceholder')}
					</Text>
				</View>
			</TouchableOpacity>
