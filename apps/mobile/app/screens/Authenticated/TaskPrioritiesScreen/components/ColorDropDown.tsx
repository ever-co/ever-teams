        ...
        <View>
            <TouchableOpacity style={styles.container} onPress={() => setShowDropdown(!showDropdown)}>
                <View style={{ flexDirection: "row", alignItems: "center", }}>
                    ...
                    <Text style={{ ...styles.textColor, color: colors.primary }}>{selectedColor ? selectedColor?.title : translate("settingScreen.priorityScreen.priorityColorPlaceholder")}</Text>
                </View>
