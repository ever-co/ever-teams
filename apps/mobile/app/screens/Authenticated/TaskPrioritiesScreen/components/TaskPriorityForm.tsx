...
const TaskPriorityForm = ({
	...
	return (
		...
		>
			...
			/>
			<ColorPickerModal visible={colorModalVisible} onDismiss={onDismissModal} setColor={setPriorityColor} />
			...
			<TouchableOpacity style={styles.colorModalButton} onPress={() => setColorModalVisible(true)}>
				<View style={{ flexDirection: 'row', alignItems: 'center' }}>
					...
					>
						{priorityColor?.toUpperCase() || translate('settingScreen.statusScreen.statusColorPlaceholder')}
					</Text>
				</View>
			</TouchableOpacity>
