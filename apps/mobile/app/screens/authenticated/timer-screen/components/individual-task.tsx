...
const IndividualTask: FC<Props> = observer(
	({
		...
		const setParent = useCallback(
			async (parentTask: ITeamTask, newTask: ITeamTask, closeModal: () => void): Promise<void> => {
			...
			>
				...
				>
					...
					>
						...
						{showDel && (
							<DeletePopUp onCloseTask={onCloseTask} setEditMode={setEditMode} setShowDel={setShowDel} />
						)}
					</View>
				</View>
			</TouchableOpacity>
