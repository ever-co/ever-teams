...
const MembersList: React.FC<IMembersList> = ({
	...
	return (
		<View style={styles.container}>
			<View style={[styles.searchContainer, { borderColor: dark ? colors.border : '#0000001A' }]}>
				<TextInput
	...
	return (
		<TouchableOpacity
			...
			style={[
				...
				{
					backgroundColor: isSelected ? (dark ? colors.border : '#F4F4F4') : 'transparent'
				}
			]}
		>
			...
			<View style={{ gap: 7, flexDirection: 'column' }}>
				<View style={styles.roleContainer}>
					<Text style={styles.roleText}>{member?.role?.name ? member?.role?.name : 'Member'}</Text>
				</View>
