...
export function useTaskLabels() {
	...
	const updateLabel = useCallback(
		async (labelData: ITaskLabelItem) => {
			if (!labelData?.id) {
	...
	const returnData = useMemo(
		...
		[labels, isLoading, isRefetching, deleteLabel, updateLabel, createLabel, allTaskLabels, refreshLabels]
	);
