...
const TaskStatus: FC<TaskStatusProps> = observer(({ task, containerStyle, status, setStatus, iconsOnly }) => {
		...
		<>
			...
			<TouchableOpacity onPress={() => setOpenModal(true)}>
				...
				>
					...
					<AntDesign name="down" size={14} color={task?.status || status ? '#000000' : colors.primary} />
				</View>
			</TouchableOpacity>
		</>
	);
