		...
		<Accordion title={translate('taskDetailsScreen.time')}>
			<View style={{ paddingBottom: 12, gap: 12 }}>
				...
				<TaskRow
					...
					labelComponent={
						<View style={[styles.labelComponent, { marginLeft: 12 }]}>
							<Text style={styles.labelText}>{translate('taskDetailsScreen.progress')}</Text>
						</View>
					}
				>
				...
				<TaskRow
					...
					labelComponent={
						<View style={[styles.labelComponent, { marginLeft: 12 }]}>
							<Text style={styles.labelText}>{translate('tasksScreen.totalTimeLabel')}</Text>
						</View>
					}
				>
				...
				<TaskRow
					...
					labelComponent={
						<View style={[styles.labelComponent, { marginLeft: 12 }]}>
							<Text style={styles.labelText}>{translate('taskDetailsScreen.timeToday')}</Text>
						</View>
					}
				>
					<Text style={[styles.timeValues, { color: colors.primary }]}>
				...
				<TaskRow
					labelComponent={
						<View style={[styles.labelComponent, { marginLeft: 12, marginTop: 3 }]}>
							<Text style={styles.labelText}>{translate('taskDetailsScreen.totalGroupTime')}</Text>
						</View>
					}
				>
					<TotalGroupTime
				...
				<TaskRow
					...
					labelComponent={
						<View style={[styles.labelComponent, { marginLeft: 12 }]}>
							<Text style={styles.labelText}>{translate('taskDetailsScreen.timeRemaining')}</Text>
						</View>
					}
				>
					<Text style={[styles.timeValues, { color: colors.primary }]}>
	...
	return (
		<View style={[styles.accordContainer, { backgroundColor: colors.background }]}>
			...
			<View style={{ gap: 7 }}>
				...
				{task?.members.length > 0 && task?.members?.length - 2 >= numMembersToShow && expanded && (
					<TouchableOpacity
