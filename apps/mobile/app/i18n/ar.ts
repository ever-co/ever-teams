...
const ar: Translations = {
  ...
  settingScreen: {
    ...
    personalSection: {
      ...
      yourContact: "جهة الاتصال الخاصة بك",
      yourContactHint: "معلومات الاتصال الخاصة بك",
      themes: "ثيمات",
      darkModeToLight: "الوضع الداكن إلى الوضع الفاتح",
      lightModeToDark: "من وضع الضوء إلى الوضع الداكن",
      language: "لغة",
      changeAvatar:"تغيير الصورة الرمزية",
      timeZone: "وحدة زمنية",
      workSchedule: "جدول العمل",
      workScheduleHint: "حدد جدول عملك الآن",
      removeAccount: "إزالة الحساب",
      removeAccountHint: "ستتم إزالة الحساب من جميع الفرق ، إلا إذا كنت المدير الوحيد",
      deleteAccount: "حذف الحساب",
      deleteAccountHint: "سيتم حذف حسابك بشكل دائم مع إعادة من جميع الفرق",
      detect: "الكشف"
    },
    teamSection: {
      name: "فريق",
      ...
      timeTrackingHint: "تمكين تتبع الوقت",
      taskStatuses: "حالات المهمة",
      taskPriorities: "أولويات المهام",
      taskSizes: "أحجام المهام",
      taskLabel: "تسمية المهمة",
      changeLogo:"تغيير الشعار",
      teamRole: "عضو مدير ودور",
      workSchedule: "جدول العمل",
      workScheduleHint: "حدد جدول عملك الآن",
      transferOwnership: "حدد جدول عملك الآن",
      transferOwnershipHint: "نقل الملكية الكاملة للفريق إلى مستخدم آخر",
      removeTeam: "إزالة الفريق",
      removeTeamHint: "سيتم إزالة الفريق تمامًا للنظام وفقد أعضاء الفريق إمكانية الوصول",
      quitTeam: "قم بإنهاء الفريق",
      quitTeamHint: "أنت على وشك ترك الفريق"
    },
    dangerZone: "منطقة الخطر",
    modalChangeLanguageTitle:"تغيير اللغة",
    languages:{
      english:"انجليزية الولايات المتحدة )",
      french:"فرنسا الفرنسية )",
      arabic:"عربي",
      russian:"الروسية",
      bulgarian:"البلغارية",
      spanish:"الأسبانية",
