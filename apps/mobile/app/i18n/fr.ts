const fr = {
	...
	loginScreen: {
		...
		confirmDetails2:
			"Veuillez saisir le code d'invitation que nous vous avons envoyé par e-mail",
	...
	settingScreen: {
		...
		personalSection: {
			...
			removeAccountHint:
				"Le compte sera supprimé de toutes les équipes, sauf si vous êtes le seul responsable",
		...
		teamSection: {
			...
			transferOwnershipHint:
				"Transférer la pleine propriété de l'équipe à un autre utilisateur",
