...
const ko: Translations = {
  ...
  settingScreen: {
    ...
    personalSection: {
      ...
      fullName: "전체 이름",
      yourContact: "귀하의 연락처",
      yourContactHint: "연락처 정보",
      themes: "테마",
      darkModeToLight: "다크 모드에서 라이트 모드로",
      lightModeToDark: "라이트 모드에서 다크 모드로",
      language: "언어",
      changeAvatar:"아바타 변경",
      timeZone: "시간대",
      workSchedule: "작업 일정",
      workScheduleHint: "지금 작업 일정 설정",
      removeAccount: "계정 삭제",
      removeAccountHint: "귀하가 유일한 관리자인 경우를 제외하고 모든 팀에서 계정이 제거됩니다.",
      deleteAccount: "계정 삭제",
      deleteAccountHint: "모든 팀에서 제거하면 계정이 영구적으로 삭제됩니다.",
      detect: "감지하다"
    },
    teamSection: {
      name: "팀",
      teamName: "팀 이름",
      timeTracking: "시간 추적",
      timeTrackingHint: "시간 추적 활성화",
      taskStatuses: "작업 상태",
      taskPriorities: "작업 우선 순위",
      taskSizes: "작업 크기",
      taskLabel: "작업 레이블",
      changeLogo:"로고 변경",
      teamRole: "관리자 구성원 및 역할",
      workSchedule: "작업 일정",
      workScheduleHint: "지금 작업 일정 설정",
      transferOwnership: "소유권 이전",
      transferOwnershipHint: "팀의 전체 소유권을 다른 사용자에게 이전",
      removeTeam: "팀 제거",
      removeTeamHint: "시스템 및 팀 구성원이 액세스할 수 없도록 팀이 완전히 제거됩니다.",
      quitTeam: "팀을 종료",
      quitTeamHint: "팀을 그만두려고 합니다."
    },
    dangerZone: "위험 구역",
    modalChangeLanguageTitle:"언어 변경",
    languages:{
      english:"영어(미국)",
      french:"프랑스어(프랑스)",
      arabic:"아라비아 말",
