...
const ko: Translations = {
  ...
  loginScreen: {
    ...
    enterDetails2: "기존 차 가입m",
    passwordFieldPlaceholder: "이곳의 비밀번호는 초비밀입니다",
    passwordFieldLabel:"비밀번호",
    tapToSignIn: "로그인하려면 클릭하세요!",
    emailFieldLabel: "귀하의 이메일",
    teamNameFieldLabel: "팀 이름",
    userNameFieldLabel: "당신의 이름",
    inviteCodeFieldLabel: "코드 초대",
    confirmCodeFieldLabel: "코드 확인",
    emailFieldPlaceholder: "이메일 주소를 입력하세요",
    teamNameFieldPlaceholder: "팀 이름을 입력하세요.",
    userNameFieldPlaceholder: "당신의 이름을 입력",
    confirmCodePlaceholder: "확인 코드 입력",
    inviteCodeFieldPlaceholder: "초대 코드 입력",
    tapCreate: "팀 만들기",
    tapConfirm: "확인하다",
    tapContinue: "계속하다",
    tapJoin: "팀에 합류",
    hint: "힌트: 원하는 이메일 주소와 원하는 비밀번호를 사용할 수 있습니다 :)",
  },
  demoNavigator: {
    componentsTab: "컴포넌트",
    debugTab: "디버그",
