const en = {
  ...
  loginScreen: {
    signIn: "Sign in",
    welcome: "Visibility for your Team",
    ...
    passwordFieldPlaceholder: "The password here is supersecret",
    passwordFieldLabel:"The password",
    tapToSignIn: "Click to login!",
    emailFieldLabel: "Your Email",
    teamNameFieldLabel: "Team Name",
    userNameFieldLabel: "Your Name",
    inviteCodeFieldLabel: "Invite Code",
    confirmCodeFieldLabel: "Confirm Code",
    emailFieldPlaceholder: "Enter your email address",
    teamNameFieldPlaceholder: "Please enter your team name",
    userNameFieldPlaceholder: "Enter your name",
    confirmCodePlaceholder: "Enter confirm code",
    inviteCodeFieldPlaceholder: "Enter Invite Code",
