...
import { IFilter } from "../../screens/authenticated/profile-screen/components/filter-popup"
...
export const TaskStoreModel = types
	...
	.props({
		...
		detailedTask: types.frozen<ITeamTask>(),
	...
	.actions((store) => ({
		...
		setDetailedTask(task: any) {
			store.detailedTask = task
		},
