...
export function createTaskRelatedIssueTypeAPI(
	data: ITaskRelatedIssueTypeCreate,
	tenantId?: string
) {
	return api.post<CreateReponse<ITaskRelatedIssueTypeCreate>>(
...
export function editTaskRelatedIssueTypeAPI(
	id: string,
	data: ITaskRelatedIssueTypeCreate,
	tenantId?: string
) {
	return api.put<CreateReponse<ITaskRelatedIssueTypeCreate>>(
		`/task-related-issue-types/${id}`,
		data,
		{
			headers: {
				'Tenant-Id': tenantId,
...
export function getTaskRelatedIssueTypeList(
	tenantId: string,
