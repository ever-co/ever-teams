							...
							<Table className="w-full">
								<TableHeader>
									<TableRow className="bg-gray-50 dark:bg-gray-800">
										<TableHead className="w-[200px] py-3">Member</TableHead>
								...
								<TableBody>
									{paginatedData?.map((dayData) => (
										<>
											<TableRow key={`date-${dayData.date}`} className="bg-gray-50/50 dark:bg-gray-800/50">
											...
											{dayData.logs?.map((projectLog) => (
												projectLog.employeeLogs?.map((employeeLog) => (
													<TableRow key={`employee-${employeeLog.employee?.id}`}>
														...
														<TableCell className="w-[80px] text-gray-500">
															{formatPercentage(0)}
														</TableCell>
														<TableCell className="w-[120px] text-gray-500">
															{formatPercentage(0)}
														</TableCell>
