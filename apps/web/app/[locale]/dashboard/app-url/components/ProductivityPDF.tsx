										...
										>
											...
											<View style={styles.percentageCell}>
												<Text style={styles.percentageText}>
													{parseFloat(
														activity.duration_percentage?.toString() || '0'
													).toFixed(1)}
													%
												</Text>
												<View style={styles.progressBar}>
													<View
														style={[
															styles.progressFill,
															{
																width: `${Math.min(parseFloat(activity.duration_percentage?.toString() || '0'), 100)}%`
															}
														]}
													/>
												</View>
					...
					<View style={styles.summarySection}>
						...
						<View style={styles.summaryGroup}>
							...
							<View style={styles.summaryRow}>
								...
								<Text style={[styles.summaryValue, styles.highlightValue]}>
									{summary.mostActiveEmployee.name}
								</Text>
							</View>
							<View style={styles.summaryRow}>
								<Text style={styles.summaryLabel}>Most Active Project:</Text>
								<Text style={[styles.summaryValue, styles.highlightValue]}>
									{summary.mostActiveProject.name}
								</Text>
							</View>
						</View>
					</View>
