...
import { ActivityRowProps, DateHeaderRowProps, DateSummaryRowProps, ProjectHeaderRowProps, ProgressBarProps } from './types';
...
export const ActivityRow: React.FC<ActivityRowProps> = ({ employee, activity }) => (
  <TableRow className="hover:bg-gray-50 dark:hover:bg-gray-800">
    ...
    <TableCell className="text-gray-600 dark:text-gray-400">{formatDuration(activity.duration.toString())}</TableCell>
    <TableCell>
