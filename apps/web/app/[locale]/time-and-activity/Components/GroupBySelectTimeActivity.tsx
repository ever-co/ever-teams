    ...
    return (
        <Select defaultValue={groupByType} onValueChange={onGroupByChange}>
            ...
            <SelectContent className="dark:bg-dark--theme-light min-w-[200px]">
                <SelectItem value="daily" className="min-w-[160px] data-[state=checked]:text-blue-600">Daily</SelectItem>
                <SelectItem value="weekly" className="min-w-[160px] data-[state=checked]:text-blue-600">Weekly</SelectItem>
                <SelectItem value="member" className="min-w-[160px] data-[state=checked]:text-blue-600">Member</SelectItem>
