...
export const EXCALIDRAW_APP_DOMAIN =
	process.env.NEXT_PUBLIC_EXCALIDRAW_APP_DOMAIN;
export const EXCALIDRAW_BACKEND_POST_URL =
	process.env.NEXT_PUBLIC_EXCALIDRAW_BACKEND_POST_URL;
export const EXCALIDRAW_FIREBASE_CONFIG =
	process.env.NEXT_PUBLIC_EXCALIDRAW_FIREBASE_CONFIG;
