  ...
  return (
    <section className="flex flex-col gap-4 p-[0.9375rem]">
      <TaskRow
        ...
        labelTitle={t('pages.taskDetails.TYPE_OF_ISSUE')}
      >
      ...
      <TaskRow
        ...
        labelTitle={t('pages.taskDetails.CREATOR')}
      >
        {task?.creator && (
          <Link
      ...
      <TaskRow
        ...
        labelTitle={t('pages.taskDetails.ASSIGNEES')}
      >
...
function DueDates() {
  ...
  return (
    <div className="flex flex-col gap-[0.4375rem]">
      <TaskRow
        labelIconPath="/assets/svg/calendar-2.svg"
        labelTitle={t('pages.taskDetails.START_DATE')}
      >
        <DatePicker
          // Button Props
          buttonVariant={'link'}
      ...
      <TaskRow
        labelTitle={t('pages.taskDetails.DUE_DATE')}
      ...
      {task?.dueDate && (
        <TaskRow
          labelTitle={t('pages.taskDetails.DAYS_REMAINING')}
          alignWithIconLabel={true}
        >
      ...
      memberList.filter((member) =>
        member.employee
          ? !task?.members
              ...
              .includes(member.employee.userId) && member.employee?.isActive
          : false
      ),
