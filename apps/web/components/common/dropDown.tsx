								...
								<div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
									...
									{edit === true ? (
										...
										<div className="bg-white dark:bg-[#18181B] p-4">
											<button
												className="rounded-[8px] bg-[#ffffff] dark:bg-[#202023] text-[16px] text-primary dark:text-white font-semibold text-center w-[239px] h-[40px] border-solid border-[1.5px] border-[#3826A6]"
												onClick={() => {
													setEdit(true);
												}}
											>
