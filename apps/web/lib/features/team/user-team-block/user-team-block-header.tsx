...
// Configuration des boutons de statut pour une meilleure maintenabilité
...
export function UserTeamBlockHeader() {
    ...
    const membersStatusNumber = useMemo(() => {
        ...
        return activeTeam.members.reduce<IFilter>((acc, item) => {
                    ...
                    {statusButtons(t, membersStatusNumber, activeTeam).map((button) => (
                        <div
                            ...
                            className={clsxm(
                                ...
                                activeFilter === button.status && 'border-primary dark:border-white  text-primary dark:text-white'
                            )}
