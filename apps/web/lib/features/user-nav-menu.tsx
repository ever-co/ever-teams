      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <ul className="w-full mt-4">
          ...
          <li className="mb-3 ">
            ...
            >
              <BriefCaseIcon className="w-5 h-5" strokeWidth="1.7" />{' '}
              <span>{t('common.MY_TASKS')}</span>
            </Link>
          </li>
          {/* Team menu */}
          <li className="mb-3">
          ...
          <li className="mb-3">
            ...
            >
              <SettingOutlineIcon className="w-5 h-5" />{' '}
          ...
          <li className="flex items-center justify-between space-x-3 font-normal">
            <div className="flex items-center flex-1 space-x-3">
              <AllSidesIcon className="w-5 h-5" />{' '}
          ...
          <li className="flex items-center justify-between mb-3 space-x-3 font-normal">
            <div className="flex items-center flex-1 space-x-3">
              <Globe2Icon className="w-5 h-5" strokeWidth="1.7" />{' '}
