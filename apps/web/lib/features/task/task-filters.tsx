			...
			>
				...
				<form onSubmit={handleSubmit} className="text-[13px] w-[90%]">
					...
					<div className="mb-4 flex items-center">
						...
						>
							<div className='mr-[10px] bg-gradient-to-tl from-[#3826A6] dark:from-regal-rose to-regal-blue rounded-full '>
								<HiMiniClock size={20} className="bg-gradient-to-tl from-regal-rose to-regal-blue rounded-full text-[#8a7bedb7] dark:text-to-regal-rose" />
							</div>
							{timeDifference}
						</div>
					</div>
					...
					<div className="flex justify-between items-center w-full">
						<Button variant='outline' type="button" className="dark:text-primary border-slate-100 dark:border-slate-600 font-bold p-[12px] h-11 rounded-[10px] border-[0.5px] dark:bg-dark--theme-light">View timesheet</Button>
