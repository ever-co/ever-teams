...
export function SettingsMenu(props: SettingsMenuProps) {
	...
	return (
		<div
			className="bg-light--theme-light dark:bg-dark--theme-light indent-0  inset-0 items-center justify-cent fixed"
		...
		>
			...
			>
				<div className="flex items-start flex-col">
					<span className="px-7 text-gray-600 dark:text-gray-400">
