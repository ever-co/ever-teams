                    ...
                    <div className="grid gap-5">
                        ...
                        <div className="">
                            <label className="block text-gray-600 mb-1 text-sm">
                                <span className="text-[12px]">Project</span><span className="text-[#de5505e1] ml-1 text-sm">*</span>
                            </label>
                            <MultiSelect
                        ...
                        <div className="">
                            <label className="block text-gray-600 mb-1 text-sm">
                                <span className="text-[12px]">Employee</span><span className="text-[#de5505e1] ml-1 text-sm">*</span>
                            </label>
                            <MultiSelect
                                items={activeTeam?.members ?? []}
                                itemToString={(members) => (members ? members.employee.fullName : '')}
                        ...
                        <div className="">
                            <label className="block text-gray-600 mb-1 text-sm">
                                <span className="text-[12px]">Status</span><span className="text-[#de5505e1] ml-1 text-sm">*</span>
                            </label>
                            <MultiSelect
                                items={statusOptions}
                        ...
                        <div className="">
                            <label className="block text-gray-600 mb-1 text-sm">
                                <span className="text-[12px]">Task</span><span className="text-[#de5505e1] ml-1 text-sm">*</span>
                            </label>
                            <MultiSelect
                                items={tasks}
                        ...
                        <div className="">
                            <label className="block text-gray-600 mb-1 text-sm">
                                <span className="text-[12px]">Activity Level</span><span className="text-[#de5505e1] ml-1 text-sm">*</span>
                            </label>
                            <MultiSelect
                                items={activeTeam?.members ?? []}
                                itemToString={(members) => (members ? members.employee.fullName : '')}
                        ...
                        <div className="">
                            <label className="block text-gray-600 mb-1 text-sm">
                                <span className="text-[12px]">Worked hours</span><span className="text-[#de5505e1] ml-1 text-sm">*</span>
                            </label>
