...
let BUILD_OUTPUT_MODE = process.env.NEXT_BUILD_OUTPUT_TYPE;
BUILD_OUTPUT_MODE = ['standalone', 'export'].includes(BUILD_OUTPUT_MODE) ? BUILD_OUTPUT_MODE : undefined;
...
const nextConfig = {
	output: BUILD_OUTPUT_MODE || undefined,
