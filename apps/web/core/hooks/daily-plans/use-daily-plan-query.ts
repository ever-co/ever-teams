...
export interface UseDailyPlanQueryOptions {
	/**
...
/**
 * Hook for querying daily plans and computing derived state.
 * Handles all READ operations and complex calculations (outstandingPlans, futurePlans, etc.).
 * Follows Single Responsibility Principle - separated from mutations.
 *
 ...
 */
export function useDailyPlanQuery(defaultEmployeeId: string | null = null, options?: UseDailyPlanQueryOptions) {
