...
export function NoTeamSkeleton({ className, fullWidth = true }: NoTeamSkeletonProps) {
	return (
		...
		>
			...
			{/* Title skeleton */}
			<div className="w-64 h-8 bg-[#F0F0F0] dark:bg-[#353741] animate-pulse rounded-sm mb-4" />

			{/* Description skeleton */}
			<div className="w-96 h-4 bg-[#F0F0F0] dark:bg-[#353741] animate-pulse rounded-sm mb-2" />
			<div className="w-80 h-4 bg-[#F0F0F0] dark:bg-[#353741] animate-pulse rounded-sm mb-5" />
