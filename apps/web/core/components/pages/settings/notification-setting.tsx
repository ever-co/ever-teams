...
export const NotificationSettings = () => {
	...
	return (
		<div id="notifications">
			<div>
				<Text className="flex-none grow-0 text-lg md-2 w-1/5 font-medium mt-8 text-[#282048] dark:text-white">
			...
			<div className="mt-8">
				<Text className="flex-none  grow-0 text-lg md-2 w-1/5 font-medium text-[#282048] dark:text-white">
