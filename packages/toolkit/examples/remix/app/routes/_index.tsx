...
export const meta: MetaFunction = () => [{ title: 'Teams Remix Boilerplate | Home' }];
		...
		<div className="min-h-screen ">
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
					<div className="text-center space-y-8">
						...
						<div className="flex justify-center gap-6">
							...
							<Link
								to="https://docs.ever.team/"
								target="_blank"
								rel={'noopener noreferrer'}
								className="group relative px-8 py-4 bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm text-gray-800 dark:text-gray-200 rounded-xl font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-gray-300 dark:border-gray-700/50"
							>
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
				<div className="space-y-32">
					{categories.map((cat) => (
						<section key={cat.name} className={`relative `}>
			...
			<div className="max-w-6xl mx-auto rounded-3xl relative overflow-hidden bg-gradient-to-r from-violet-500 to-fuchsia-500 dark:from-violet-600 dark:to-fuchsia-600">
