...
const NavBar = () => {
	...
	return (
		<header className="container sticky mb-8 top-8 left-0 right-0 rounded-3xl  z-50 backdrop-blur-md flex h-[64px] items-center justify-between px-8  border border-slate-200 dark:border-slate-800 bg-white dark:bg-black">
