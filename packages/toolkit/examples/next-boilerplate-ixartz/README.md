...
- Clone next-boilerplate-ixartz repository
- Set it up (Integrate it), in Teams Turbo Repo
- Removed some tools : husly, .github, workflows, CI, ...

### What needs to be done

- Use Teams SDK components in the boilerplate
- Set up Clerk Auth with Gauzy Auth
- Work on DB Sync (Boilerplate DB and Gauzy DB) through API
- Work on Internationalization using next-intl
- ... TBC (To be completed)
