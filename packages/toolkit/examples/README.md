# Teams Kit Examples / Samples

- `/website` - tiny NextJs-based website with a catalog of existing examples. Available at <https://examples.ever.team>.

Current examples:
- `/base` - example [NextJs](https://github.com/vercel/next.js) App with functionality to browse/review all Teams Kit components. Available at <https://kit-examples-base.ever.team>.
