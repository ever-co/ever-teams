...
export default function TeamsEssentialTimerPage() {
	return (
		<div className="space-y-8">
			<PageTitle
				title="Teams Essential Timer Components"
				description="Collection of Teams Essential Timer Components for building Teams applications."
			/>
