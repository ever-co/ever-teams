...
export default function TeamsCustomTimerPage() {
	return (
		<div className="space-y-8">
			<PageTitle
				title="Teams Custom Timer Components"
				description="Collection of Teams Custom Timer Components for building Teams applications."
			/>
