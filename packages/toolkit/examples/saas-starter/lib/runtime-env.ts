 ...
 *
 * Server only: call it from a server component or a route handler; client components receive the
 * value as a prop. Whitespace-only counts as unset, so a secret-store placeholder does not become an
 * unusable value.
 */
