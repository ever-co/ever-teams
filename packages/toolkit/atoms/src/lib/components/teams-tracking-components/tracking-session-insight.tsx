...
interface TeamsTrackingSessionInsightProps {
	className?: string;
}

const TeamsTrackingSessionInsight: React.FC<TeamsTrackingSessionInsightProps> = ({ className }) => {
	...
	return (
		...
		>
			...
			{/* Analytics Content */}
			<SessionInsight decodedPayloads={activePayloads} />
			{error && (
				<div
...
export default TeamsTrackingSessionInsight;
export { TeamsTrackingSessionInsight };
export type { TeamsTrackingSessionInsightProps };
