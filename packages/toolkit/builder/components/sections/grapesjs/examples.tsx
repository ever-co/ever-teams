						...
						<div className="space-y-12">
							<div className="prose dark:prose-invert max-w-none mb-8">
								<p className="text-lg text-slate-600 dark:text-slate-400">
									Explore how to integrate and customize Teams components within GrapesJS. Each
									component can be easily configured through the GrapesJS traits panel.
								</p>
							</div>
  ...
  return <div id="gjs" className="h-screen" />;
			...
			<div className="mt-24 text-center">
				...
				<p className="text-slate-600 dark:text-slate-400 mb-8 max-w-2xl mx-auto">
					Start creating custom time tracking interfaces with GrapesJS&apos;s visual editor and Teams&apos;s
					components.
				</p>
				<CtaButton href="/grapesjs" className="mx-auto">
					Try Teams on GrapesJS
				</CtaButton>
			</div>
		</div>
	);
