import { ApiKeyDisplayProps } from "../../../types";
import { maskApiKey } from '@/utils/helpers';

export const ApiKeyDisplay = ({ apiKey, onReset }: ApiKeyDisplayProps) => (
  <div className="space-y-4">
    <div className="p-4 bg-slate-100 dark:bg-slate-800 rounded-md">
      <p className="text-sm text-slate-600 dark:text-slate-400">Current API Key:</p>
      <p className="font-mono text-slate-800 dark:text-slate-200">{maskApiKey(apiKey)}</p>
    </div>
    <button
      onClick={onReset}
